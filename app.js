...
const MARKET_WON_DOLLAR_EXPORT_MARGIN_2026_IMAGE = {
  src: "images/market-won-dollar-export-margin-2026-1280.webp",
  alt: "원달러 환율과 수출기업 비용 구조를 점검하는 외환 시장 이미지",
  sourceUrl: "https://commons.wikimedia.org/",
  width: 1280,
  height: 720,
};

const MARKET_OIL_INFLATION_RATE_PATH_2026_IMAGE = {
  src: "images/market-oil-inflation-rate-path-2026-1280.webp",
  alt: "유가와 물가, 금리 경로를 함께 읽는 에너지 시장 이미지",
...
const US_STOCKS_NVIDIA_AI_MARGIN_2026_IMAGE = {
  src: "images/us-stocks-nvidia-ai-margin-2026-1280.webp",
  alt: "엔비디아 AI 인프라와 데이터센터 투자 사이클을 떠올리게 하는 이미지",
...
const KOREAN_STOCKS_SAMSUNG_MEMORY_CYCLE_2026_IMAGE = {
  src: "images/korean-stocks-samsung-memory-cycle-2026-1280.webp",
  alt: "삼성전자 메모리 업황과 현금흐름 회복을 함께 보는 이미지",
...
const KOREAN_STOCKS_SKHYNIX_HBM_CUSTOMER_RISK_2026_IMAGE = {
  src: "images/korean-stocks-skhynix-hbm-customer-risk-2026-1280.webp",
  alt: "SK하이닉스 HBM 성장과 고객 집중 리스크를 함께 보는 반도체 이미지",
  sourceUrl: "https://commons.wikimedia.org/w/index.php?curid=121166788",
  width: 1280,
  height: 720,
};

const THEME_AI_DATA_CENTER_POWER_GRID_2026_IMAGE = {
  src: "images/theme-ai-data-center-power-grid-2026-1280.webp",
  alt: "AI 데이터센터와 전력망 병목을 함께 보여주는 산업 테마 이미지",
  sourceUrl: "https://commons.wikimedia.org/wiki/File:Servers_in_a_Rack.jpg",
  width: 1280,
  height: 720,
};

const THEME_DEFENSE_EXPORT_BACKLOG_CASHFLOW_2026_IMAGE = {
  src: "images/theme-defense-export-backlog-cashflow-2026-1280.webp",
  alt: "방산 수출 수주잔고와 납품 현금흐름을 함께 보는 이미지",
  sourceUrl: "https://commons.wikimedia.org/wiki/File:Coordinated_thunder_-_1_of_7.jpg",
  width: 1280,
  height: 720,
};

const THEME_BIOTECH_CDMO_ORDER_CYCLE_2026_IMAGE = {
  src: "images/theme-biotech-cdmo-order-cycle-2026-1280.webp",
  alt: "바이오 CDMO 공장 가동률과 장기 수주를 함께 보는 이미지",
...
const EARNINGS_OPERATING_MARGIN_FREE_CASH_FLOW_2026_IMAGE = {
  src: "images/earnings-operating-margin-free-cash-flow-2026-1280.webp",
  alt: "기업 실적표와 자유현금흐름을 비교하는 분석 이미지",
  sourceUrl: "https://commons.wikimedia.org/wiki/File:E-ticker.jpg",
  width: 1280,
  height: 720,
};

const EARNINGS_GUIDANCE_REVENUE_QUALITY_2026_IMAGE = {
  src: "images/earnings-guidance-revenue-quality-2026-1280.webp",
  alt: "기업 가이던스와 매출 성장률을 분석하는 차트 이미지",
  sourceUrl: "https://commons.wikimedia.org/wiki/File:NYSE_Advanced_Trading_Floor.jpg",
  width: 1280,
  height: 720,
};

const EARNINGS_INVENTORY_SURPRISE_RISK_2026_IMAGE = {
  src: "images/earnings-inventory-surprise-risk-2026-1280.webp",
  alt: "실적 서프라이즈 뒤 재고와 매출채권 위험을 점검하는 이미지",
  sourceUrl: "https://commons.wikimedia.org/wiki/File:Market_data_on_display_at_Taiwan_Stock_Exchange_20210208.jpg",
  width: 1280,
  height: 720,
};

const ETF_COVERED_CALL_INCOME_RISK_2026_IMAGE = {
  src: "images/etf-covered-call-income-risk-2026-1280.webp",
  alt: "커버드콜 ETF의 월분배금과 옵션 프리미엄 구조를 설명하는 이미지",
  sourceUrl: "https://commons.wikimedia.org/wiki/File:Trading_Floor_at_the_New_York_Stock_Exchange.jpg",
  width: 1280,
  height: 720,
};

const ETF_DIVIDEND_GROWTH_PAYOUT_RATIO_2026_IMAGE = {
  src: "images/etf-dividend-growth-payout-ratio-2026-1280.webp",
  alt: "배당성장주의 배당성향과 현금흐름을 점검하는 이미지",
  sourceUrl: "https://commons.wikimedia.org/wiki/File:Individual_gas_meters.jpg",
  width: 1280,
  height: 720,
};

const ETF_BOND_DURATION_RATE_CYCLE_2026_IMAGE = {
  src: "images/etf-bond-duration-rate-cycle-2026-1280.webp",
  alt: "채권 ETF의 듀레이션과 금리 민감도를 설명하는 이미지",
  sourceUrl: "https://commons.wikimedia.org/wiki/File:Driveway_and_house_for_sale_sign_-_geograph.org.uk_-_4901404.jpg",
  width: 1280,
  height: 720,
};

const STRATEGY_PORTFOLIO_CASH_REBALANCING_2026_IMAGE = {
  src: "images/strategy-portfolio-cash-rebalancing-2026-1280.webp",
  alt: "포트폴리오 현금 비중과 리밸런싱 원칙을 설명하는 이미지",
  sourceUrl: "https://commons.wikimedia.org/wiki/File:Calculator_and_Money.jpg",
  width: 1280,
  height: 720,
};

const STRATEGY_TENBAGGER_QUALITY_CHECKLIST_2026_IMAGE = {
  src: "images/strategy-tenbagger-quality-checklist-2026-1280.webp",
  alt: "텐베거 후보 기업의 성장성과 이익 전환을 점검하는 이미지",
  sourceUrl: "https://commons.wikimedia.org/",
  width: 1280,
  height: 720,
};

const STRATEGY_LOSS_CUT_POSITION_SIZING_2026_IMAGE = {
  src: "images/strategy-loss-cut-position-sizing-2026-1280.webp",
  alt: "손실 제한과 포지션 사이징 원칙을 설명하는 투자 전략 이미지",
...
const RELATED_STOCKS_BY_TICKER = {
  ...
  "000660.KS": { name: "SK하이닉스", market: "한국", ticker: "000660.KS", url: "https://m.stock.naver.com/domestic/stock/000660/total" },
  "003230.KS": { name: "삼양식품", market: "한국", ticker: "003230.KS", url: "https://m.stock.naver.com/domestic/stock/003230/total" },
  "005380.KS": { name: "현대차", market: "한국", ticker: "005380.KS", url: "https://m.stock.naver.com/domestic/stock/005380/total" },
  "005490.KS": { name: "POSCO홀딩스", market: "한국", ticker: "005490.KS", url: "https://m.stock.naver.com/domestic/stock/005490/total" },
  "005930.KS": { name: "삼성전자", market: "한국", ticker: "005930.KS", url: "https://m.stock.naver.com/domestic/stock/005930/total" },
  "006800.KS": { name: "미래에셋증권", market: "한국", ticker: "006800.KS", url: "https://m.stock.naver.com/domestic/stock/006800/total" },
  "010130.KS": { name: "고려아연", market: "한국", ticker: "010130.KS", url: "https://m.stock.naver.com/domestic/stock/010130/total" },
  "010950.KS": { name: "S-Oil", market: "한국", ticker: "010950.KS", url: "https://m.stock.naver.com/domestic/stock/010950/total" },
  "012450.KS": { name: "한화에어로스페이스", market: "한국", ticker: "012450.KS", url: "https://m.stock.naver.com/domestic/stock/012450/total" },
  "012750.KS": { name: "에스원", market: "한국", ticker: "012750.KS", url: "https://m.stock.naver.com/domestic/stock/012750/total" },
  "015760.KS": { name: "한국전력", market: "한국", ticker: "015760.KS", url: "https://m.stock.naver.com/domestic/stock/015760/total" },
  "017670.KS": { name: "SK텔레콤", market: "한국", ticker: "017670.KS", url: "https://m.stock.naver.com/domestic/stock/017670/total" },
  "021240.KS": { name: "코웨이", market: "한국", ticker: "021240.KS", url: "https://m.stock.naver.com/domestic/stock/021240/total" },
  "035420.KS": { name: "NAVER", market: "한국", ticker: "035420.KS", url: "https://m.stock.naver.com/domestic/stock/035420/total" },
  "035720.KS": { name: "카카오", market: "한국", ticker: "035720.KS", url: "https://m.stock.naver.com/domestic/stock/035720/total" },
  "047810.KS": { name: "한국항공우주", market: "한국", ticker: "047810.KS", url: "https://m.stock.naver.com/domestic/stock/047810/total" },
  "051900.KS": { name: "LG생활건강", market: "한국", ticker: "051900.KS", url: "https://m.stock.naver.com/domestic/stock/051900/total" },
  "068270.KS": { name: "셀트리온", market: "한국", ticker: "068270.KS", url: "https://m.stock.naver.com/domestic/stock/068270/total" },
  "086280.KS": { name: "현대글로비스", market: "한국", ticker: "086280.KS", url: "https://m.stock.naver.com/domestic/stock/086280/total" },
  "097950.KS": { name: "CJ제일제당", market: "한국", ticker: "097950.KS", url: "https://m.stock.naver.com/domestic/stock/097950/total" },
  "105560.KS": { name: "KB금융", market: "한국", ticker: "105560.KS", url: "https://m.stock.naver.com/domestic/stock/105560/total" },
  "112610.KS": { name: "씨에스윈드", market: "한국", ticker: "112610.KS", url: "https://m.stock.naver.com/domestic/stock/112610/total" },
  "207940.KS": { name: "삼성바이오로직스", market: "한국", ticker: "207940.KS", url: "https://m.stock.naver.com/domestic/stock/207940/total" },
  "259960.KS": { name: "크래프톤", market: "한국", ticker: "259960.KS", url: "https://m.stock.naver.com/domestic/stock/259960/total" },
  "395400.KS": { name: "SK리츠", market: "한국", ticker: "395400.KS", url: "https://m.stock.naver.com/domestic/stock/395400/total" },
  "454910.KS": { name: "두산로보틱스", market: "한국", ticker: "454910.KS", url: "https://m.stock.naver.com/domestic/stock/454910/total" },
  "AA": { name: "알코아", market: "미국", ticker: "AA", url: "https://m.stock.naver.com/worldstock/stock/AA/total" },
  ...
  "CVS": { name: "CVS 헬스", market: "미국", ticker: "CVS", url: "https://m.stock.naver.com/worldstock/stock/CVS/total" },
  "CVX": { name: "셰브론", market: "미국", ticker: "CVX", url: "https://m.stock.naver.com/worldstock/stock/CVX/total" },
  "DAL": { name: "델타 에어라인스", market: "미국", ticker: "DAL", url: "https://m.stock.naver.com/worldstock/stock/DAL/total" },
  "DDOG": { name: "데이터도그", market: "미국", ticker: "DDOG", url: "https://m.stock.naver.com/worldstock/stock/DDOG.O/total" },
  "DE": { name: "디어", market: "미국", ticker: "DE", url: "https://m.stock.naver.com/worldstock/stock/DE/total" },
  ...
  "MELI": { name: "메르카도리브레", market: "미국", ticker: "MELI", url: "https://m.stock.naver.com/worldstock/stock/MELI.O/total" },
  ...
  "NNVC": { name: "나노바이리사이드스", market: "미국", ticker: "NNVC", url: "https://m.stock.naver.com/worldstock/stock/NNVC.K/total" },
  ...
  "PG": { name: "P&G(프록터 & 갬블)", market: "미국", ticker: "PG", url: "https://m.stock.naver.com/worldstock/stock/PG/total" },
  "PINS": { name: "핀터레스트", market: "미국", ticker: "PINS", url: "https://m.stock.naver.com/worldstock/stock/PINS.K/total" },
  "PL": { name: "플래닛 랩스 PBC", market: "미국", ticker: "PL", url: "https://m.stock.naver.com/worldstock/stock/PL/total" },
...
const RELATED_STOCK_TICKERS_BY_DESK = {
  "인공지능": ["NVDA", "MSFT", "GOOGL", "PLTR"],
  "클라우드 컴퓨팅": ["MSFT", "AMZN", "GOOGL", "DDOG"],
  "전기차": ["TSLA", "RIVN", "LCID", "005380.KS"],
  "운송·물류": ["FDX", "UBER", "000120.KS", "086280.KS"],
  "우주 기술": ["RKLB", "PL", "ASTS", "012450.KS"],
  "재생에너지": ["FSLR", "ENPH", "PLUG", "112610.KS"],
  "전통 에너지": ["XOM", "CVX", "COP", "010950.KS"],
  "반도체": ["NVDA", "AMD", "000660.KS", "005930.KS"],
  "사이버보안": ["CRWD", "PANW", "FTNT", "OKTA"],
  "산업 자동화": ["HON", "ROK", "EMR", "ETN"],
  "로보틱스": ["ISRG", "PATH", "SYM", "454910.KS"],
  "나노기술": ["NNDM", "NNE", "NBTX", "NNVC"],
  "사물인터넷": ["IOT", "CSCO", "QCOM", "SENS"],
  "에너지 원자재": ["UROY", "CCJ", "UEC", "010130.KS"],
  "농업·식품": ["CTVA", "DE", "ADM", "097950.KS"],
  ...
  "하드웨어": ["AAPL", "DELL", "HPQ", "005930.KS"],
  "가상·증강현실": ["META", "AAPL", "MSFT", "035420.KS"],
  "전자상거래": ["AMZN", "MELI", "EBAY", "035420.KS"],
  "디지털 엔터테인먼트": ["DIS", "RBLX", "EA", "259960.KS"],
  "소비재": ["PG", "KO", "PEP", "051900.KS"],
  "스마트홈": ["AAPL", "AMZN", "GOOGL", "021240.KS"],
  ...
  "고령화": ["LLY", "HUM", "CVS", "068270.KS"],
  "건강식품": ["CELH", "SMPL", "HLF", "003230.KS"],
  "암호화폐·블록체인": ["COIN", "MSTR", "MARA", "RIOT"],
  "핀테크": ["MA", "PYPL", "AFRM", "006800.KS"],
};
...
const deskAgentNames = {
  "인공지능": ["Elena", "Marcus", "Beatrice", "Vivian"],
  "클라우드 컴퓨팅": ["Jasper", "Clara", "Celine", "Hugo"],
  "전기차": ["Oliver", "Nora", "Daphne", "Felix"],
  "운송·물류": ["Miles", "Serena", "Gemma", "Victor"],
  "우주 기술": ["Adrian", "Stella", "Miranda", "Conrad"],
  "재생에너지": ["Iris", "Rafael", "Celeste", "Naomi"],
  "전통 에너지": ["Ethan", "Laura", "Roland", "Graham"],
  "반도체": ["Julian", "Sophia", "Irene", "Martin"],
  "사이버보안": ["Lucas", "Maya", "Desmond", "Oscar"],
  "산업 자동화": ["Daniel", "Fiona", "Petra", "Patrick"],
  "로보틱스": ["Leo", "Amelia", "Ingrid", "Vincent"],
  "나노기술": ["Theo", "Hannah", "Sylvia", "Roman"],
  "사물인터넷": ["Noah", "Elise", "Rowan", "Simon"],
  "에너지 원자재": ["Colin", "Diana", "Gavin", "Gareth"],
  "농업·식품": ["Aaron", "Chloe", "Phoebe", "Bennett"],
  "소프트웨어": ["Owen", "Grace", "Quinn", "Malcolm"],
  "양자컴퓨팅": ["Quentin", "Nadia", "Eleanor", "Cedric"],
  "방산·항공우주": ["Arthur", "Helena", "Sienna", "Damian"],
  "통신": ["Isaac", "Julia", "Audrey", "Trevor"],
  "자율 시스템": ["Logan", "Erica", "Xavier", "Calvin"],
  "금속 원자재": ["Mason", "Lydia", "Bruno", "Russell"],
  "환경 지속가능성": ["Elliot", "Freya", "Cora", "Tobias"],
  "하드웨어": ["Harold", "Mia", "Gideon", "Wesley"],
  "가상·증강현실": ["Sebastian", "Luna", "Bianca", "Dexter"],
  "전자상거래": ["Henry", "Olivia", "Portia", "Maxwell"],
  "디지털 엔터테인먼트": ["Tristan", "Bella", "Violet", "Dominic"],
  "소비재": ["Nathan", "Emma", "Poppy", "Warren"],
  "스마트홈": ["Gabriel", "Alice", "Casper", "Preston"],
  "헬스케어·바이오테크": ["Samuel", "Rachel", "Elaine", "Derek"],
  "핀테크": ["Benjamin", "Ava", "Nadine", "Lionel"],
  "생체인식": ["Caleb", "Zoe", "Tessa", "Everett"],
  "빅데이터": ["Andrew", "Leah", "Aria", "Spencer"],
  "소셜미디어": ["Dylan", "Victoria", "Riley", "Nolan"],
  "부동산·리츠": ["George", "Isabelle", "Claudia", "Raymond"],
  "웨어러블": ["Liam", "Megan", "Heidi", "Peter"],
  "에듀테크": ["Charles", "Natalie", "Eloise", "Thomas"],
  "고령화": ["Edward", "Monica", "Rosalind", "Lawrence"],
  "건강식품": ["Alex", "Rebecca", "Lillian", "Philip"],
  "암호화폐·블록체인": ["Ryan", "Camille", "Archer", "Morgan"],
};
...
const SITE_NAME = "Eurekan Research";
const SCHEMA_CONTEXT = "https://schema.org";
const SEO_LANGUAGE = "ko-KR";
const DEFAULT_ROBOTS = "index, follow";
const TWITTER_CARD_TYPE = "summary";
const DEFAULT_SEO_DESCRIPTION = "Eurekan Research는 인공지능, 반도체, 전기차, 클라우드, 방산, 바이오, 핀테크 등 39개 투자 테마를 장문으로 정리하는 투자 정보 매거진입니다.";
...
let speechChunkFallbackTimer = 0;
let speechRunId = 0;
...
function getPageRelatedStockTickers(page) {
  if (Array.isArray(page?.relatedStockTickers) && page.relatedStockTickers.length) {
    return page.relatedStockTickers.slice(0, 4);
  }

  const slug = String(page?.slug || "");
  const desk = normalizeDesk(page?.desk);
  return (RELATED_STOCK_TICKERS_BY_SLUG[slug] || RELATED_STOCK_TICKERS_BY_DESK[desk] || []).slice(0, 4);
}

function getPageRelatedStocks(page) {
  return getPageRelatedStockTickers(page)
    .map((ticker) => RELATED_STOCKS_BY_TICKER[ticker])
...
function getSliderGroupItems(items = []) {
  ...
  const sliderWidth = Math.max(pageListNode?.clientWidth || 0, articleBodyNode?.clientWidth || 0, window.innerWidth || 0);
  const railCardWidth = Math.min(390, Math.max(CARD_MIN_WIDTH, sliderWidth * 0.26));
  const viewportFillCount = Math.ceil((sliderWidth + railCardWidth) / (railCardWidth + CARD_GAP)) + 1;
  const minCount = Math.max(items.length, SLIDER_MIN_GROUP_ITEM_COUNT, viewportFillCount);
...
function normalizeArticleVideoSection(page) {
  const videoNode = articleBodyNode.querySelector(".article-video");
  if (!videoNode) return;

  const video = getPageVideo(page);
  if (!video) return;

  const hasPoster = Boolean(videoNode.querySelector(".article-video__poster[data-video-play] img"));
  const currentYoutubeId = getYouTubeIdFromValue(videoNode.dataset.youtubeId || "");
  if (hasPoster && currentYoutubeId === video.youtubeId) return;

  const wrapper = document.createElement("div");
  wrapper.innerHTML = renderArticleVideo(page).trim();
  const normalizedNode = wrapper.firstElementChild;
  if (!normalizedNode) return;

  videoNode.replaceWith(normalizedNode);
}
...
function renderArticleEnhancements(page) {
  ...
  normalizeArticleVideoSection(page);
...
function clearSpeechChunkFallbackTimer() {
  clearTimeout(speechChunkFallbackTimer);
  speechChunkFallbackTimer = 0;
}

function stopSpeechKeepAliveTimer() {
...
function startSpeechKeepAliveTimer(runId) {
  ...
  speechKeepAliveTimer = window.setInterval(() => {
    ...
    try {
      ...
      if (!window.speechSynthesis.speaking && activeUtterance) window.speechSynthesis.resume();
    } catch {
      stopSpeechKeepAliveTimer();
    }
...
function scheduleSpeechChunkFallback(runId, chunkIndex, chunk) {
  clearSpeechChunkFallbackTimer();
  const estimatedDurationMs = Math.ceil((chunk.text.length / SPEECH_ESTIMATED_CHARS_PER_SECOND) * 1000);
  const fallbackDelay = Math.max(SPEECH_CHUNK_MIN_FALLBACK_MS, estimatedDurationMs + SPEECH_CHUNK_FALLBACK_EXTRA_MS);
  speechChunkFallbackTimer = window.setTimeout(() => {
    if (runId !== speechRunId || isArticleSpeechStopping || !isArticleSpeechPlaying) return;
    if (activeSpeechChunkIndex !== chunkIndex) return;
...
function createSpeechChunks(text = activeArticleSpeechText, startOffset = 0) {
  ...
  let cursor = Math.max(0, Math.min(rawText.length, Number(startOffset) || 0));

  while (cursor < rawText.length) {
    while (cursor < rawText.length && /\s/.test(rawText[cursor])) cursor += 1;
    if (cursor >= rawText.length) break;
    ...
    const chunkEnd = sentenceEnd > cursor ? sentenceEnd : rawText.length;
    const chunkText = rawText.slice(cursor, chunkEnd).trim();
    if (chunkText) {
      chunks.push({
        start: cursor,
        end: cursor + chunkText.length,
        text: chunkText,
      });
    }
    cursor = chunkEnd;
...
function finishArticleSpeech(runId) {
...
function queueSpeechChunks(runId, startChunkIndex = activeSpeechChunkIndex) {
  ...
  const chunkIndex = Math.max(0, Number(startChunkIndex) || 0);
  if (chunkIndex >= activeSpeechChunks.length) {
    finishArticleSpeech(runId);
    return;
  }

  const utterance = createSpeechUtterance(runId, chunkIndex);
  if (!utterance) {
    finishArticleSpeech(runId);
    return;
  }
